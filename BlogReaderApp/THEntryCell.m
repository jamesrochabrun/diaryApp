...
- (void)layoutSubviews {
    ...
    [[_dateLabel.topAnchor constraintEqualToAnchor:_mainImageView.bottomAnchor constant:kGeomCellPadding] setActive:true];
    ...
    [[_calendarIcon.centerYAnchor constraintEqualToAnchor:_dateLabel.centerYAnchor] setActive:true];
    ...
    [[_locationLabel.topAnchor constraintEqualToAnchor:_dateLabel.bottomAnchor constant:5] setActive:true];
    ...
    [[_locationIcon.centerYAnchor constraintEqualToAnchor:_locationLabel.centerYAnchor] setActive:true];
    ...
    [[_moodImageView.centerYAnchor constraintEqualToAnchor:_locationLabel.centerYAnchor] setActive:true];
    [[_moodImageView.heightAnchor constraintEqualToConstant:kGeomCellIconSize] setActive:true];
    [[_moodImageView.widthAnchor constraintEqualToConstant:kGeomCellIconSize] setActive:true];
    [[_moodImageView.rightAnchor constraintEqualToAnchor:self.rightAnchor constant: -kGeomCellPadding] setActive:true];
    
    [[_heartImage.widthAnchor constraintEqualToConstant:kGeomCellIconSize] setActive:true];
    [[_heartImage.heightAnchor constraintEqualToConstant:kGeomCellIconSize] setActive:true];
    [[_heartImage.rightAnchor constraintEqualToAnchor:self.rightAnchor constant:-kGeomCellPadding] setActive:true];
    [[_heartImage.centerYAnchor constraintEqualToAnchor:_dateLabel.centerYAnchor]setActive:true];
    
    [[self.line.bottomAnchor constraintEqualToAnchor:_dateLabel.bottomAnchor] setActive:true];
